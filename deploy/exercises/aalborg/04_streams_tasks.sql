...
-- ============================================================================
CREATE OR REPLACE STREAM STUDENTS_STREAM ON TABLE AALBORG_DB.RAW.STUDENTS_RAW;
CREATE OR REPLACE STREAM TEACHERS_STREAM ON TABLE AALBORG_DB.RAW.TEACHERS_RAW;
CREATE OR REPLACE STREAM CLASSES_STREAM ON TABLE AALBORG_DB.RAW.CLASSES_RAW;
...
AS
MERGE INTO AALBORG_DB.CLEAN.STUDENTS t
USING (
...
AS
MERGE INTO AALBORG_DB.CLEAN.TEACHERS t
USING (
    SELECT *, CONCAT(first_name, ' ', last_name) as full_name 
...
AS
MERGE INTO AALBORG_DB.CLEAN.CLASSES t
...
-- VERIFY
-- ============================================================================
SHOW STREAMS IN SCHEMA AALBORG_DB.CDC;
SHOW TASKS IN SCHEMA AALBORG_DB.CDC;
