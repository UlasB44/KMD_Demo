...
-- ============================================================================
-- Replace AALBORG with your assigned municipality (uppercase)
...
-- Grant permissions
GRANT USAGE ON DATABASE AALBORG_DB TO ROLE AALBORG_ANALYST;
GRANT USAGE ON SCHEMA AALBORG_DB.RAW TO ROLE AALBORG_ANALYST;
GRANT USAGE ON SCHEMA AALBORG_DB.CLEAN TO ROLE AALBORG_ANALYST;
GRANT SELECT ON ALL TABLES IN SCHEMA AALBORG_DB.RAW TO ROLE AALBORG_ANALYST;
GRANT SELECT ON ALL TABLES IN SCHEMA AALBORG_DB.CLEAN TO ROLE AALBORG_ANALYST;
...
/*
CREATE OR REPLACE ROW ACCESS POLICY AALBORG_RLS AS (municipality_code NUMBER) 
RETURNS BOOLEAN ->
    CASE
...
-- Apply to tables
ALTER TABLE RAW.STUDENTS_RAW ADD ROW ACCESS POLICY AALBORG_RLS ON (municipality_code);
ALTER TABLE RAW.TEACHERS_RAW ADD ROW ACCESS POLICY AALBORG_RLS ON (municipality_code);
ALTER TABLE RAW.CLASSES_RAW ADD ROW ACCESS POLICY AALBORG_RLS ON (municipality_code);
*/
