...
-- ============================================================================
CREATE OR REPLACE STREAM STUDENTS_STREAM ON TABLE AARHUS_DB.RAW.STUDENTS_RAW;
CREATE OR REPLACE STREAM TEACHERS_STREAM ON TABLE AARHUS_DB.RAW.TEACHERS_RAW;
CREATE OR REPLACE STREAM CLASSES_STREAM ON TABLE AARHUS_DB.RAW.CLASSES_RAW;
...
AS
MERGE INTO AARHUS_DB.CLEAN.STUDENTS t
USING (
...
AS
MERGE INTO AARHUS_DB.CLEAN.TEACHERS t
USING (
    SELECT *, CONCAT(first_name, ' ', last_name) as full_name 
...
AS
MERGE INTO AARHUS_DB.CLEAN.CLASSES t
...
-- VERIFY
-- ============================================================================
SHOW STREAMS IN SCHEMA AARHUS_DB.CDC;
SHOW TASKS IN SCHEMA AARHUS_DB.CDC;
