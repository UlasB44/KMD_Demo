...
-- ============================================================================
-- Replace ODENSE with your assigned municipality (uppercase)
...
-- Grant permissions
GRANT USAGE ON DATABASE ODENSE_DB TO ROLE ODENSE_ANALYST;
GRANT USAGE ON SCHEMA ODENSE_DB.RAW TO ROLE ODENSE_ANALYST;
GRANT USAGE ON SCHEMA ODENSE_DB.CLEAN TO ROLE ODENSE_ANALYST;
GRANT SELECT ON ALL TABLES IN SCHEMA ODENSE_DB.RAW TO ROLE ODENSE_ANALYST;
GRANT SELECT ON ALL TABLES IN SCHEMA ODENSE_DB.CLEAN TO ROLE ODENSE_ANALYST;
...
/*
CREATE OR REPLACE ROW ACCESS POLICY ODENSE_RLS AS (municipality_code NUMBER) 
RETURNS BOOLEAN ->
    CASE
...
-- Apply to tables
ALTER TABLE RAW.STUDENTS_RAW ADD ROW ACCESS POLICY ODENSE_RLS ON (municipality_code);
ALTER TABLE RAW.TEACHERS_RAW ADD ROW ACCESS POLICY ODENSE_RLS ON (municipality_code);
ALTER TABLE RAW.CLASSES_RAW ADD ROW ACCESS POLICY ODENSE_RLS ON (municipality_code);
*/
